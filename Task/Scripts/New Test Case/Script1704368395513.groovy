...
Mobile.startApplication('D:\\Downloads\\General-Store.apk', true)
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Enter name here'), 'Menna', 0)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/android.widget.LinearLayout'), 0)
Thread.sleep(300)
